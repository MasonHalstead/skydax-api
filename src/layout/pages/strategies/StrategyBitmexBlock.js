...
import { getBitmexCandles as getBitmexCandlesOperator } from 'ducks/operators/charts';
import { selectBitmexCandle, selectBitmexCandles } from 'ducks/selectors';
...
class ConnectedStrategyBitmexBlock extends Component {
  static propTypes = {
  ...
  handleChartData = async () => {
    const { setLoading, handleApiError, getBitmexCandles } = this.props;
    ...
    return (
      <div className={cn.panelLeft}>
        <div className={cn.header}>
          <p className={cn.exchange}>BitMEX XBTUSD</p>
...
const mapStateToProps = state => ({
  user: state.user,
  candle: selectBitmexCandle(state),
...
export const StrategyBitmexBlock = connect(
  mapStateToProps,
  mapDispatchToProps,
)(ConnectedStrategyBitmexBlock);
